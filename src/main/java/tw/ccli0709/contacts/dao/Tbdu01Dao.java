...
@Repository
public interface Tbdu01Dao extends JpaRepository<Tbdu01, Long> {
	...
	@Query(value = "SELECT t1.CNAME,t2.LASTDATE " + "FROM sdms.tbdu01 t1, sdms.tbdu02 t2 "
			+ "where t1.USERNO = t2.USERNO", nativeQuery = true)
	List<Object[]> findByNativeJoin();
}
